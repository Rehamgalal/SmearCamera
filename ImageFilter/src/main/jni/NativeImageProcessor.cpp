...
Java_com_example_imagefilter_imageprocessors_NativeImageProcessor_applyRGBCurve(JNIEnv *env,
                                                                                jclass clazz,
                                                                                jintArray pixels,
                                                                                jintArray rgb,
                                                                                jint width,
...
JNIEXPORT jintArray JNICALL
Java_com_example_imagefilter_imageprocessors_NativeImageProcessor_applyChannelCurves(JNIEnv *env,
                                                                                     jclass clazz,
                                                                                     jintArray pixels,
                                                                                     jintArray r,
                                                                                     jintArray g,
...
JNIEXPORT jintArray JNICALL
Java_com_example_imagefilter_imageprocessors_NativeImageProcessor_doBrightness(JNIEnv *env,
                                                                               jclass clazz,
                                                                               jintArray pixels,
                                                                               jint value,
                                                                               jint width,
...
JNIEXPORT jintArray JNICALL
Java_com_example_imagefilter_imageprocessors_NativeImageProcessor_doContrast(JNIEnv *env,
                                                                             jclass clazz,
                                                                             jintArray pixels,
                                                                             jfloat value,
                                                                             jint width,
...
JNIEXPORT jintArray JNICALL
Java_com_example_imagefilter_imageprocessors_NativeImageProcessor_doColorOverlay(JNIEnv *env,
                                                                                 jclass clazz,
                                                                                 jintArray pixels,
                                                                                 jint depth,
                                                                                 jfloat red,
...
JNIEXPORT jintArray JNICALL
Java_com_example_imagefilter_imageprocessors_NativeImageProcessor_doSaturation(JNIEnv *env,
                                                                               jclass clazz,
                                                                               jintArray pixels,
                                                                               jfloat level,
                                                                               jint width,
