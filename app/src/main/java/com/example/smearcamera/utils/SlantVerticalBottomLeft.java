...
public class SlantVerticalBottomLeft extends androidx.appcompat.widget.AppCompatImageView {
    public SlantVerticalBottomLeft(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    @Override
    ...
    public static Bitmap getRoundedCroppedBitmap(Bitmap bitmap, int widht, int height) {
        ...
        Point point1_draw = new Point(0, height);
        Point point2_draw = new Point(0, 0);
        Point point3_draw = new Point((widht/3), 0);
        Point point4_draw = new Point(widht-(widht/3), height);
