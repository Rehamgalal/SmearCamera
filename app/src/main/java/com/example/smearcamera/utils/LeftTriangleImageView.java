...
public class LeftTriangleImageView extends androidx.appcompat.widget.AppCompatImageView {
    public LeftTriangleImageView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public static Bitmap getRoundedCroppedBitmap(Bitmap bitmap, int widht, int height) {
        ...
        Point point1_draw = new Point(widht, height/2);
