...
public class SmallSlantView extends androidx.appcompat.widget.AppCompatImageView {
    public SmallSlantView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public static Bitmap getRoundedCroppedBitmap(Bitmap bitmap, int widht, int height) {
        ...
        Point point3_draw = new Point(0,  0);
        Point point4_draw = new Point(widht, (int) (height/6));
