...
public class SlantTopView extends androidx.appcompat.widget.AppCompatImageView {
    public SlantTopView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public static Bitmap getRoundedCroppedBitmap(Bitmap bitmap, int widht, int height) {
        ...
        Point point2_draw = new Point(0, height-(height/6));
