...
public class DigonalRightBottom extends androidx.appcompat.widget.AppCompatImageView {
    public DigonalRightBottom(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
