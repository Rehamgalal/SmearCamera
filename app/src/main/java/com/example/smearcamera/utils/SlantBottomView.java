...
public class SlantBottomView extends androidx.appcompat.widget.AppCompatImageView {

    public SlantBottomView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public static Bitmap getRoundedCroppedBitmap(Bitmap bitmap, int widht, int height) {
        ...
        Point point3_draw = new Point(0, (int) (height/7));
        Point point4_draw = new Point(widht, height-(int) (height*0.55));
