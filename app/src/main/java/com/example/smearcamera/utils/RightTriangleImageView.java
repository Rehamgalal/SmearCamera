...
public class RightTriangleImageView extends androidx.appcompat.widget.AppCompatImageView {
    public RightTriangleImageView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    @Override
    ...
    public static Bitmap getRoundedCroppedBitmap(Bitmap bitmap, int widht, int height) {
        ...
        Point point1_draw = new Point(0, height/2);
        Point point2_draw = new Point(widht, 0);
        Point point3_draw = new Point(widht, height);
