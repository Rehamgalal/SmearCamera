...
public class TopTraingleImageView extends androidx.appcompat.widget.AppCompatImageView {

    public TopTraingleImageView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public static Bitmap getRoundedCroppedBitmap(Bitmap bitmap, int widht, int height) {
        ...
        Point point1_draw = new Point(widht/2, height);
        Point point2_draw = new Point(0, 0);
        Point point3_draw = new Point(widht, 0);
