...
public class DiagonalTopLeft extends androidx.appcompat.widget.AppCompatImageView {
    public DiagonalTopLeft(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    @Override
