...
public class FivePhotosActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_five_photos);
        ...
        one = new Five1Fragment();
        one.setArguments(bundle);
        two = new Five2Fragment();
        two.setArguments(bundle);
        three = new Five3Fragment();
        three.setArguments(bundle);
        four = new Five4Fragment();
        four.setArguments(bundle);
        five = new Five5Fragment();
        five.setArguments(bundle);
        six = new Five6Fragment();
        six.setArguments(bundle);
        seven = new Five7Fragment();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.save:
                ...
                AlertDialog.Builder builder1 = new AlertDialog.Builder(FivePhotosActivity.this);
