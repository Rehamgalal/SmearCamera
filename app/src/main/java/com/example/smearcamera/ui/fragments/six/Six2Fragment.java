package com.example.smearcamera.ui.fragments.six;
...
public class Six2Fragment extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            uri6 = Uri.parse(getArguments().getString("uri6"));
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_six2, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        imageView6 = view.findViewById(R.id.sixth);
        ...
        Glide.with(context).load(uri6).centerCrop().into(imageView6);
    }
}