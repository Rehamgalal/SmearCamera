...
import com.example.smearcamera.ui.fragments.four.Four1Fragment;
import com.example.smearcamera.ui.fragments.four.Four2Fragment;
import com.example.smearcamera.ui.fragments.four.Four3Fragment;
import com.example.smearcamera.ui.fragments.four.Four4Fragment;
import com.example.smearcamera.ui.fragments.four.Four5Fragment;
import com.example.smearcamera.ui.fragments.four.Four6Fragment;
import com.example.smearcamera.ui.fragments.four.Four7Fragment;
...
public class FourPhotosActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_four_photos);
        ...
        one = new Four1Fragment();
        one.setArguments(bundle);
        two = new Four2Fragment();
        two.setArguments(bundle);
        three = new Four3Fragment();
        three.setArguments(bundle);
        four = new Four4Fragment();
        four.setArguments(bundle);
        five = new Four5Fragment();
        five.setArguments(bundle);
        six = new Four6Fragment();
        six.setArguments(bundle);
        seven = new Four7Fragment();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.save:
                ...
                AlertDialog.Builder builder1 = new AlertDialog.Builder(FourPhotosActivity.this);
